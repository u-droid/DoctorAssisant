...
public class Requested extends AppCompatActivity {
    ...
    private void loadAppointments() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_REQUESTED, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<array.length();i++){
                        ...
                        RequestedAppointmentAdapter adapter=new RequestedAppointmentAdapter(Requested.this,appointmentList);
